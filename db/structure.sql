...
CREATE TABLE 'books_fts_docsize'(docid INTEGER PRIMARY KEY, size BLOB);
CREATE TABLE 'books_fts_segdir'(level INTEGER,idx INTEGER,start_block INTEGER,leaves_end_block INTEGER,end_block INTEGER,root BLOB,PRIMARY KEY(level, idx));
